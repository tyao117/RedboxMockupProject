...
public class UpdateSecureEmployee {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (rs.next()) {
            ...
            //String updateQuery = String.format("UPDATE employees SET password='%s' WHERE email='%s' ;", "classta", id);
            String updateQuery = String.format("UPDATE employees SET password='%s' WHERE email='%s' ;", encryptedPassword, id);
        ...
        System.out.println(updateQueryList.size());
        int count = 0;
